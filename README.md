...
This reservation app is a model of an application used by a local resturant.The reservation application allows clients to create and edit reservations as well as search current reservations using the telephone number related to the reservation. 
...
link: https://reservation-start.vercel.app/dashboard

### Features

- View of the default dashboard(with the current date)

![Dashboard](/images/dashboardview.PNG)

- View of the search page, reservations found by phone number.

![SearchView](/images/searchview.PNG)

- View of the reservation page, entering data will create a reservation (reservation-time is on 24-hour clock/military time. EX: 18:00 === 6:00PM)

![ReservationFormView](/images/reservationform.PNG)

- View of the create table page

![TableFormView](/images/tableform.PNG)


- View of cancel reservation event, once canceled can not be undone. 
